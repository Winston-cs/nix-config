...
in {
  ...
  options.my.style = mkOption {
    type = types.enum (builtins.attrNames themeSchemes);
    default = "rose-pine";
    description = "Select theme to use with Stylix.";
  }; 

  config = {
    stylix.enable = true;
    stylix.polarity = "dark";
    stylix.base16Scheme = themeSchemes.${cfg};
